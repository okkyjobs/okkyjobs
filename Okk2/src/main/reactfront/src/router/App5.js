...
function App5() {
  return (
    ...
    <div className="App">
                  ...
                  <div className='line'>
                    ...
                    <div>
                      ...
                      <a className='career-manage3'style={{ textDecoration: "none"}} href='Okky4'>
                        <img className='pic-class3' src={require('./img/shoping3.PNG')}></img>
                        <span className='career-font'>사용 이력관리</span>
                      </a>
                      <a className='career-manage31'style={{ textDecoration: "none"}} href='Okky5'>
                        <img className='pic-class31' src={require('./img/young2.PNG')}></img>
      ...
      <div className='right-main5'>
       
       <div className='buy-log5'>채용 담당자 관리</div>
        <div className='buy-log25'>채용 담당자 초대는 최대 3인까지 가능합니다.</div>
       <div className='button-main5'>
       <button className='button-all5'>+ 초대</button>
       </div>
       <div className='table-main'>
      <table className='table'>
        <thead className='table-thead'>
          <th className='man-name'>담당자이름</th>
          <th className='man-email'>이메일</th>
          <th className='man-phone'>연락처</th>
          <th className='man-day'>날짜</th>
          <th className='man-ok'>수락상태</th>
        </thead>
      </table>
      </div>
      </div>
      ...
      <div className='footer5'>
                <div className='cat5'>
                    <img className='footer-cat5' src={require('./img/cat.png')}/>
                </div>
                <div className='footer-main5'>
                <div className='footer-bar5'>
                    <button type='button5'>1</button>
                </div>
                </div>
              </div>

              <div className='footer25'>
                <div className='footer-logo5'>
                  <div  className='ok-logo5'>
                    <img className='ok-logo25' src={require('./img/okkylogo.png')}/>
                    <h2 className='ok-logoside5'>All That Developer</h2>
                    </div>
                    <div>
                    <img className='facebook5' src={require('./img/facebook.png')}/>
                    </div>
                    <div>
                    <img className='youtube5' src={require('./img/youtube.png')}/>
                    </div>
                    <div>
                    <img className='email5' src={require('./img/email.png')}/>
                    </div>

                </div>
              </div>
              <div className='footer-middle5'>
                <div className='footer-btn5'>
                  <div className='button-one5'>
                  <button>회사소개</button>
                  </div>
                  <div className='button-two5'>
                  <button>공지사항</button>
                  </div>
                  <div className='button-three5'>
                  <button>FAQ</button>
                  </div>
                  <div className='button-four5'>
                  <button>통합 서비스 이용약관</button>
                  </div>
                  <div className='button-five5'>
                ...
                <div className='text-one5'>
                <div>상호명:(주)오키코리아|대표명:노상범, 장기진</div>
                </div>
                <div className='text-two5'>
                <div>사업자등록번호: 592-87-02037 | 통신판매업신고번호: 제 2022-서울강남-04742호 | 직업정보 제공사업 신고번호: J1200020230009</div>
                </div>
                <div className='text-three5'>
                <div>주소: 서울 강남구 봉은사로 303 TGL경복빌딩 502호 (06103) | 고객센터 : jobs@okky.kr (영업시간 평일 10:00~17:00) 주말 · 공휴일 휴무</div>
                </div>
                <div className='text-four5'>
                <div>© 2024 (주)오키코리아, Inc. All rights reserved.</div>
                </div>
                </div>

                 <div className='last-footer5'>
                <div className='iname-ncloud5'>
                <div className='sponse5'>
                  <h2>SPONSORED BY</h2>
                </div>
                <div>
                <img className='iname5' src={require('./img/inames.png')}/>
                </div>
                <div>
                <img className='ncloud5' src={require('./img/ncloud.png')}/>
                </div>
                </div>
                </div>
