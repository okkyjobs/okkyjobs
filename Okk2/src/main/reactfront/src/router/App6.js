  ...
  return (
    ...
    <div className="App">
              ...
              <aside className='left-box'>
                <nav className='left-box-nav'>
                  ...
                  <div className='line'>
                    ...
                    <div>
                      <a className='career-manage31'style={{ textDecoration: "none"}} href='Okky6'>
                        <img className='pic-class' src={require('./img/eryukseo6.png')}></img>
      ...
      <div className='right-main'>
       ...
       <div className='buy-log'>관심 구직자</div>
      ...
      <div className='footer6'>
                <div className='cat6'>
                    <img className='footer-cat6' src={require('./img/cat.png')}/>
                </div>
                <div className='footer-main6'>
                <div className='footer-bar6'>
                    <button type='button6'>1</button>
                </div>
                </div>
              </div>

              <div className='footer26'>
                <div className='footer-logo6'>
                  <div  className='ok-logo6'>
                    <img className='ok-logo26' src={require('./img/okkylogo.png')}/>
                    <h2 className='ok-logoside6'>All That Developer</h2>
                    </div>
                    <div>
                    <img className='facebook6' src={require('./img/facebook.png')}/>
                    </div>
                    <div>
                    <img className='youtube6' src={require('./img/youtube.png')}/>
                    </div>
                    <div>
                    <img className='email6' src={require('./img/email.png')}/>
                    </div>

                </div>
              </div>
              <div className='footer-middle6'>
                <div className='footer-btn6'>
                  <div className='button-one6'>
                  <button>회사소개</button>
                  </div>
                  <div className='button-two6'>
                  <button>공지사항</button>
                  </div>
                  <div className='button-three6'>
                  <button>FAQ</button>
                  </div>
                  <div className='button-four6'>
                  <button>통합 서비스 이용약관</button>
                  </div>
                  <div className='button-five6'>
                ...
                <div className='footer-text6'>
                <div className='text-one6'>
                <div>상호명:(주)오키코리아|대표명:노상범, 장기진</div>
                </div>
                <div className='text-two6'>
                <div>사업자등록번호: 592-87-02037 | 통신판매업신고번호: 제 2022-서울강남-04742호 | 직업정보 제공사업 신고번호: J1200020230009</div>
                </div>
                <div className='text-three6'>
                <div>주소: 서울 강남구 봉은사로 303 TGL경복빌딩 502호 (06103) | 고객센터 : jobs@okky.kr (영업시간 평일 10:00~17:00) 주말 · 공휴일 휴무</div>
                </div>
                <div className='text-four6'>
                <div>© 2024 (주)오키코리아, Inc. All rights reserved.</div>
                </div>
                </div>

                <div className='last-footer6'>
                <div className='iname-ncloud6'>
                <div className='sponse6'>
                  <h2>SPONSORED BY</h2>
                </div>
                <div>
                <img className='iname6' src={require('./img/inames.png')}/>
                </div>
                <div>
                <img className='ncloud6' src={require('./img/ncloud.png')}/>
                </div>
                </div>
                </div>
