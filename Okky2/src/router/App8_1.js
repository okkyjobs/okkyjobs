  ...
  return (
    ...
    <div className="App">
                ...
                <nav className='left-box-nav'>
                  ...
                  <div className='line'>
                    ...
                    <div>
                      ...
                      <a className='career-manage3' style={{ textDecoration: "none"}} href='Okky4'>
                        <img className='pic-class3' src={require('./img/shoping2.png')}></img>
                  ...
                  <div className='line'>
                    ...
                    <div>
                      ...
                      <a className='career-manage31'style={{ textDecoration: "none"}} href='Okky8'>
                        <img className='pic-class31' src={require('./img1/positionEryuk8.png')}></img>
      ...
      <div className='right-main'>
       ...
       <a href='Okky8'>
        <button className='posion-button8_1'>계약직</button>
        </a>
        
        <button className='mypage-button8_1'>정규직</button>
        
       </div>
       <div className='buy-log'>정규직 채용 관리</div>
   
       <div className='button-main'>
       <label>
       <select className='filter-main'>
        <option value='-1'>전체</option>
        <option value='13'>채용 진행중</option>
        <option value='14'>마감된 채용 포지션</option>
       ...
       <div className='posisoin-search'></div>
       <input type='text' className='posioin-search2' placeholder='포지션 검색'></input>
       <img className="posioin-search3" src={require('./img/search.png')}/>
      </div>
      ...
      <div className='footer8'>
                <div className='cat8'>
                    <img className='footer-cat8' src={require('./img/cat.png')}/>
                </div>
                <div className='footer-main8'>
                <div className='footer-bar8'>
                    <button type='button8'>1</button>
                </div>
                </div>
              </div>

              <div className='footer28'>
                <div className='footer-logo8'>
                  <div  className='ok-logo8'>
                    <img className='ok-logo28' src={require('./img/okkylogo.png')}/>
                    <h2 className='ok-logoside8'>All That Developer</h2>
                    </div>
                    <div>
                    <img className='facebook8' src={require('./img/facebook.png')}/>
                    </div>
                    <div>
                    <img className='youtube8' src={require('./img/youtube.png')}/>
                    </div>
                    <div>
                    <img className='email8' src={require('./img/email.png')}/>
                    </div>

                </div>
              </div>
              <div className='footer-middle8'>
                <div className='footer-btn8'>
                  <div className='button-one8'>
                  <button>회사소개</button>
                  </div>
                  <div className='button-two8'>
                  <button>공지사항</button>
                  </div>
                  <div className='button-three8'>
                  <button>FAQ</button>
                  </div>
                  <div className='button-four8'>
                  <button>통합 서비스 이용약관</button>
                  </div>
                  <div className='button-five8'>
                ...
                <div className='footer-text8'>
                <div className='text-one8'>
                <div>상호명:(주)오키코리아|대표명:노상범, 장기진</div>
                </div>
                <div className='text-two8'>
                <div>사업자등록번호: 592-87-02037 | 통신판매업신고번호: 제 2022-서울강남-04742호 | 직업정보 제공사업 신고번호: J1200020230009</div>
                </div>
                <div className='text-three8'>
                <div>주소: 서울 강남구 봉은사로 303 TGL경복빌딩 502호 (06103) | 고객센터 : jobs@okky.kr (영업시간 평일 10:00~17:00) 주말 · 공휴일 휴무</div>
                </div>
                <div className='text-four8'>
                <div>© 2024 (주)오키코리아, Inc. All rights reserved.</div>
                </div>
                </div>

                <div className='last-footer8'>
                <div className='iname-ncloud8'>
                <div className='sponse8'>
                  <h2>SPONSORED BY</h2>
                </div>
                <div>
                <img className='iname8' src={require('./img/inames.png')}/>
                </div>
                <div>
                <img className='ncloud8' src={require('./img/ncloud.png')}/>
                </div>
                </div>
                </div>
