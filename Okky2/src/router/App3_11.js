    ...
    <div className="App3_1App3">
                ...
                <nav className='App3_1left-box-nav'>
                  ...
                  <div className='App3_1line'>
                    ...
                    <div>
                      ...
                      <a className='App3_1career-manage22' style={{ textDecoration: "none"}} href='Okky3'>
      ...
      <div className='App3_1right-main'>
       <div className='App3_1button'>
        <a href='Okky3_1'>
        <button className='App3_1posion-button11'href='Okky3_1'>포지션 등록권</button>
        </a>
        <button className='App3_1mypage-button11'href='Okky3_11'>이력서 열람권</button>
       </div>
       <div className='App3_1buy-log'>구매 이력관리</div>
       <div className='App3_1right-filter'>열람권 총 0개 / 사용 0개 / 잔여 0개</div>
