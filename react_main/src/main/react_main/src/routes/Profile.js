                      ...
                      <div className='profile-main-box'>
                        <div className='main-subbox'>
                          <div className='name-box'>
                            ...
                            <input value={name} id="minutes" onChange={onChange} type='text' className='name-input'></input>
                          </div>
                                ...
                                <div className='tag-control'>
                                  <div className='tag-control2'>
                                    ...
                                    <div className='tag-pLeft' data-value>
                                      <input id="minutes" onChange={onChangeWishtag} autoComplete='off' autoCapitalize='none' autoCorrect='off' spellCheck='false' tabIndex='0' type='text' aria-autocomplete='list' aria-expanded='false' aria-haspopup='true' role='combobox' className='tag-input-box'></input>
                                    </div>
                                  </div>
                                <div className='arrow'>
