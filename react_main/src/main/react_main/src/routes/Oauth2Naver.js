...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    localStorage.setItem('user', JSON.stringify({id: user.id, password : user.password, email: user.email, name : user.name, nickname : user.nickname, wishtag : wishtag, emailAgree : emailAgree, type : type, serviceAgree :  serviceAgree, personalInfoAgree : personalInfoAgree, provider : "Naver", profileImage : profileImage, checkUsernameFlag : checkUsernameFlag}));
        navigate('/oksignup');
           ...
           <div className='sign_in_logo'>
            ...
            <div className='center'>
                ...
                <button type='button' className='but-box'>
                  ...
                  <button  type='submit'  className='sign-up-but' onClick={(e) => {setInfo();okSign();}}>
