...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    localStorage.setItem('user', JSON.stringify({ id: id, password : password, email: email, name : name, nickname : nickname, wishtag : wishtag, emailAgree : emailAgree, type : type, serviceAgree : serviceAgree, personalInfoAgree : personalInfoAgree, provider : "Google", profileImage : profileImage, checkUsernameFlag : checkUsernameFlag}));
    navigate('/oksignup');
            ...
            <div className='center'>
                ...
                <button type='button' className='but-box'>
                    ...
                    <div className='but-container'>
                        <span className='google-login-span'>GOOGLE LOGIN</span>
